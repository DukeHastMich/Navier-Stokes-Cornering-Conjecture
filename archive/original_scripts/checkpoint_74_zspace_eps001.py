...
np.savetxt('/mnt/data/checkpoint_74_zspace_eps001_trace.csv',rows,delimiter=',',header=header,comments='')
np.save('/mnt/data/checkpoint_74_zspace_eps001_shapes.npy',shapes)
...
np.savetxt('/mnt/data/checkpoint_74_zspace_eps001_logR.csv',np.column_stack([rows[:,0],logR]),delimiter=',',header='s,logR_cumulative',comments='')
with open('/mnt/data/checkpoint_74_zspace_eps001_results.txt','w') as f:
...
print(open('/mnt/data/checkpoint_74_zspace_eps001_results.txt').read())
