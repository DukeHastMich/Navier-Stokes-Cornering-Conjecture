...
with open('outputs/checkpoint_80_geometry_search.txt','w') as f:
 ...
 if best:
  np.save('outputs/checkpoint_80_bestP.npy',best[0][5])
print(open('outputs/checkpoint_80_geometry_search.txt').read()[:6000])
