...
def run(N):
    ...
    np.savetxt(f'/mnt/data/checkpoint_78_N{N}.csv',arr,delimiter=',',header='s,rho,reach,curv_radius,half_nonlocal_sep',comments='')
...
with open('/mnt/data/checkpoint_78_reach_convergence.txt','w') as f:
