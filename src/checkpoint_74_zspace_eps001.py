...
np.savetxt('outputs/checkpoint_74_zspace_eps001_trace.csv',rows,delimiter=',',header=header,comments='')
np.save('outputs/checkpoint_74_zspace_eps001_shapes.npy',shapes)
...
np.savetxt('outputs/checkpoint_74_zspace_eps001_logR.csv',np.column_stack([rows[:,0],logR]),delimiter=',',header='s,logR_cumulative',comments='')
with open('outputs/checkpoint_74_zspace_eps001_results.txt','w') as f:
...
print(open('outputs/checkpoint_74_zspace_eps001_results.txt').read())
