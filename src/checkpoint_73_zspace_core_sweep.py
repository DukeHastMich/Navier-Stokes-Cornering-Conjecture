...
np.savetxt('outputs/checkpoint_73_zspace_core_sweep.csv',arr,delimiter=',',header='eps,rho0,first_rho_nonnegative_s,first_eps_ge_reach_s,min_rho,min_reach',comments='')
with open('outputs/checkpoint_73_zspace_core_sweep.txt','w') as f:
...
print(open('outputs/checkpoint_73_zspace_core_sweep.txt').read())
