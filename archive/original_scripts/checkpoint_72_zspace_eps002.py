...
np.savetxt('/mnt/data/checkpoint_72_zspace_eps002_trace.csv',rows,delimiter=',',header=header,comments='')
np.save('/mnt/data/checkpoint_72_zspace_eps002_shapes.npy',shapes)
...
np.savetxt('/mnt/data/checkpoint_72_zspace_eps002_logR.csv',np.column_stack([rows[:,0],logR]),delimiter=',',header='s,logR_cumulative',comments='')
with open('/mnt/data/checkpoint_72_zspace_eps002_results.txt','w') as f:
...
print(open('/mnt/data/checkpoint_72_zspace_eps002_results.txt').read())
