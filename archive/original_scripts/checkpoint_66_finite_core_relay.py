...
for nu in nus:
    ...
    np.savetxt(f'/mnt/data/checkpoint_66_trace_Re{tag}.csv',arr,delimiter=',',
...
with open('/mnt/data/checkpoint_66_finite_core_relay.txt','w') as f:
...
print(open('/mnt/data/checkpoint_66_finite_core_relay.txt').read())
