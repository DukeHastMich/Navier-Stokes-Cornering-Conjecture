...
np.savetxt('outputs/checkpoint_82_resolved_core_sweep.csv',arr,delimiter=',',header='N,core,rho0,mincyc0,reach0,spacing0,first_fail_s,first_overlap_s,min_reach,elapsed',comments='')
with open('outputs/checkpoint_82_resolved_core_sweep.txt','w') as f:
