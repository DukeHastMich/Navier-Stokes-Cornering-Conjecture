...
np.savetxt('outputs/checkpoint_71_zspace_trace.csv',rows,delimiter=',',header=header,comments='')
np.save('outputs/checkpoint_71_zspace_shapes.npy',shapes)
...
np.savetxt('outputs/checkpoint_71_zspace_logR.csv',np.column_stack([rows[:,0],logR]),delimiter=',',header='s,logR_cumulative',comments='')
with open('outputs/checkpoint_71_zspace_results.txt','w') as f:
...
print(open('outputs/checkpoint_71_zspace_results.txt').read())
