...
arr=np.array(rows)
np.savetxt('outputs/checkpoint_81_resolved_zrelay.csv',arr,delimiter=',',header='s,rho,cyc0,cyc1,cyc2,cyc3,reach,curv_radius,half_nonlocal_sep,L,spacing,core_over_reach,spacing_over_core',comments='')
with open('outputs/checkpoint_81_resolved_zrelay.txt','w') as f:
...
print(open('outputs/checkpoint_81_resolved_zrelay.txt').read())
