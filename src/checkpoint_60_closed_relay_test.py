...
np.savetxt(
    'outputs/checkpoint_60_closed_relay_trace.csv', rows, delimiter=',',
    header='t,alpha_3to0,alpha_0to1,alpha_1to2,alpha_2to3,rg2dot,length,L_over_Rg,u_rms',
    comments=''
)

with open('outputs/checkpoint_60_closed_relay_test.txt','w') as f:
...
print(open('outputs/checkpoint_60_closed_relay_test.txt').read())
