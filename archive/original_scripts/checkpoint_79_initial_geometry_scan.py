...
arr=np.array(rows)
np.savetxt('/mnt/data/checkpoint_79_initial_geometry_scan.csv',arr,delimiter=',',header='f,rho,cyc0,cyc1,cyc2,cyc3,reach,curv_radius,half_nonlocal_sep,L,spacing,eps_over_reach,spacing_over_eps',comments='')
