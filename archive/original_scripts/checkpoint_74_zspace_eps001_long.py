...
N=80; M=4; DS=0.0015; SMAX=5.0; REPARAM_EVERY=5
...
np.savetxt('/mnt/data/checkpoint_74_zspace_eps001_long.csv',arr,delimiter=',',header='eps,rho0,first_rho_nonnegative_s,first_eps_ge_reach_s,min_rho,min_reach',comments='')
with open('/mnt/data/checkpoint_74_zspace_eps001_long.txt','w') as f:
...
print(open('/mnt/data/checkpoint_74_zspace_eps001_long.txt').read())
